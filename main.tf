...
resource "aws_route_table_association" "a-rtb-subnet-asso"{
...
resource "aws_instance" "myapp-server"{
    ...
    associate_public_ip_address = true #This setting automatically gives a public IP address to an EC2 instance at launch
